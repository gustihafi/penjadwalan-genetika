...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2018 at 07:51 AM
...
(85, '1234567898765431', 'Maesaroh, S.Pd', '', '', 'bf521ed82123cf4e0e01bba6865cb53e'),
(86, '1234567898765432', 'Abdul Somat, Lc', '', '', '7855f9dfd846adfd93aabd1921bfdfcd'),
(87, '1234567898765433', 'Abdul Ruhiyat, S.Pd', '', '', '81fdbf5d39188d64422d8856cd360f35'),
...
(108, '', 'Dra. Susetyawati', '', '', ''),
(109, '1234567898765434', 'Ahmad Faizol, S.Pd', '', '', '761e8172afd7435fca5cebe9c2f39a05'),
...
CREATE TABLE IF NOT EXISTS `jadwalpelajaran` (
  ...
  PRIMARY KEY (`kode`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='hasil proses' AUTO_INCREMENT=97 ;
...
CREATE TABLE IF NOT EXISTS `matapelajaran` (
  ...
  PRIMARY KEY (`kode`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='example kode_mk = 0765109 ' AUTO_INCREMENT=145 ;
