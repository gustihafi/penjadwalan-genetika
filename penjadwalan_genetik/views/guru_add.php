   ...
   <div class="container-fluid">
      <div class="row-fluid">
        ...
        <form id="tab" method="POST" >
            ...
            <input id="tahun" type="text" value="<?php echo set_value('tahun');?>" name="tahun" class="input-xlarge" />
			 <label>Masa Kerja</label>
            <input id="masa_kerja" type="text" value="<?php echo set_value('masa_kerja');?>" name="masa_kerja" class="input-xlarge" />
